...
class Customer:
    def __init__(self, unique_ID, name, address, phone):       # define the class and attribute
...
def manageCustomer():
    ...
    for Customer in customerList:
        if Customer.unique_ID == findID:
            print("Unique ID:", Customer.unique_ID)                 # input the id you want to manage
            print("Name:", Customer.name)                           # shows the ID information
            print("Adress:", Customer.address )
...
def manageCustomer(): 
    ...
    for Customer in customerList: 
        if Customer.unique_ID == findID: 
            ...
            print("Address:", Customer.address)                     # shows User Info
            print("Phone Number:", Customer.phone)
            print() 
            ...
            while True:  
                ...
                elif option == 2:                                       # delete User
                    while True: 
                        confirm = input(
                            f"Are you sure you are removing "
                            f"{Customer.name} permanently? (y/n): "     # confirmation
                        )
